...
to the simple  MPI example. All other examples are also configured to
...
The DAX for the MPI hello world workflow can be generated by running the
generate_dax.sh script from the mpi directory, like this:
...
To plan the mpi workflow invoke the pegasus-plan command using the
