...
public class BlackDiamondDAX {
	...
	/**
	 * Commented out as we create separate catalog files for this example
         */
	/*
	fa.addPhysicalFile("file://" + cwd + "/f.a", "hpcc");
        dax.addFile(fa);
        ...
        preprocess.addPhysicalFile("file://" + pegasus_bin_dir + "/pegasus-keg", "hpcc");
        ...
        findrange.addPhysicalFile("file://" + pegasus_bin_dir + "/pegasus-keg", "hpcc");
        ...
        analyze.addPhysicalFile("file://" + pegasus_bin_dir + "/pegasus-keg", "hpcc");
	...
	*/
	...
	System.out.println( "Adding left findrange job..." );
	...
	System.out.println( "Adding right findrange job..." );
        ...
        // Add analyze job
	System.out.println( "Adding analyze  job..." );
